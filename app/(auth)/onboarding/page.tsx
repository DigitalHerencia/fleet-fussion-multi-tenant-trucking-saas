...
export default function OnboardingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const slug = toBaseSlug(formData.companyName);
      ...
      const onboardingData: OnboardingData = {
        ...
        orgSlug: slug, // Pass base slug, server will ensure uniqueness
        dotNumber: formData.dotNumber.trim(),
        mcNumber: formData.mcNumber.trim(),
        address: formData.address.trim(),
        city: formData.city.trim(),
...
async function SetClerkMetadata(onboardingData: OnboardingData): Promise<{ success: boolean; organizationId?: string; error?: string }> {
  try {
