          ...
          <section className="space-y-6">
            <div>
              ...
              <p>
                ...
                trucking and logistics companies with cutting-edge, affordable,
                and easy-to-use Transportation Management Software (TMS). We
                believe technology should accelerate your fleet’s success — not
                complicate it.
              </p>
            </div>
            <div>
              ...
              <p>
                Fleet Fusion is proudly based in Anthony, New Mexico —
                strategically positioned to serve fleets across the Southwest
                and beyond. We are logistics specialists, technologists, and
                passionate innovators committed to building world-class fleet
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Transparency: Clear, simple pricing with no hidden fees.
                </li>
            ...
            <div>
              ...
              <p className="mt-2">
                Join a growing community of fleet operators who trust Fleet
                Fusion to manage their operations, improve compliance, and boost
                profitability.
              </p>
            </div>
          </section>
