...
// Import types
import { TimeSeriesData, ProfitabilityMetrics } from '@/types/analytics';
...
export default async function AnalyticsPage({
  ...
  const metrics = [
    ...
    <div className="mx-auto min-h-screen w-full max-w-7xl space-y-6 bg-neutral-900 p-6 pt-8">
      {/* Mobile Detection for Conditional Rendering */}      <div className="block md:hidden">
        <MobileAnalytics
          data={{
            summary,
            performanceData,
      ...
      <div className="mb-2 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        ...
        </div>        <div className="mt-4 flex flex-col gap-2 md:mt-0 md:flex-row">
          <ExportOptions 
            orgId={orgId}
            filters={filters}
            data={{
      ...
      <Tabs defaultValue="performance" className="w-full">
        ...
        <TabsContent value="financial" className="mt-4">
          <Card className="rounded-md border border-gray-200 bg-black">
            ...
            <CardContent className="overflow-x-auto pb-4">              <FinancialMetrics
                timeRange={timeRange}
                financialData={[profitabilityMetrics]}
                expenseBreakdown={[]}
              />
        ...
        </TabsContent>        <TabsContent value="vehicles" className="mt-4">
          <Card className="rounded-md border border-gray-200 bg-black">
            <CardHeader className="pt-4 pb-2">
              <span className="text-lg font-bold text-white">
                Vehicle Utilization
        ...
        <TabsContent value="interactive" className="mt-4">
          <Card className="rounded-md border border-gray-200 bg-black">
            ...
            <CardContent className="overflow-x-auto pb-4">              <InteractiveCharts
                data={{
                  summary,
                  performanceData,
                  financialData: profitabilityMetrics,
        ...
        <TabsContent value="geographic" className="mt-4">
          <Card className="rounded-md border border-gray-200 bg-black">
            ...
            <CardContent className="overflow-x-auto pb-4">              <GeographicAnalysis
                data={{
                  summary,
                  performanceData,
                  financialData: profitabilityMetrics,
              ...
              <CardContent className="pb-4">
                <div className="space-y-6">
                  <div className="text-sm text-white/80">
                    Use advanced filters to drill down into specific metrics and create custom reports.
                  </div>
