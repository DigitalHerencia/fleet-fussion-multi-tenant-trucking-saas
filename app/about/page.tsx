    ...
    return (
        <div className="flex flex-col min-h-screen relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-0">
                <Image
                    src="/ChatGPT Image Apr 27, 2025, 03_33_43 PM.png"
                ...
                <div className="w-full max-w-3xl bg-card/90 backdrop-blur-sm rounded-lg shadow-md p-6 md:p-8 mx-auto mb-60 md:mb-80 lg:mb-96">
                    ...
                    <section className="space-y-6">
                        <div>
                            ...
                            <p>
                                At Fleet Fusion, our mission is to empower small and mid-sized
                                trucking and logistics companies with cutting-edge, affordable, and
                                easy-to-use Transportation Management Software (TMS). We believe
                                technology should accelerate your fleet’s success — not complicate
                                it.
                            </p>
                        </div>
                        <div>
                            ...
                            <p>
                                Fleet Fusion is proudly based in Anthony, New Mexico — strategically
                                positioned to serve fleets across the Southwest and beyond. We are
                                logistics specialists, technologists, and passionate innovators
                                committed to building world-class fleet management solutions
                                tailored for the SME market.
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="mt-2">
                                Our flexible plans are designed to grow with your business, from
                                small startups to enterprise-level operations.
                            </p>
                        </div>
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-1">
                                ...
                                <li>
                                    Innovation: Constantly evolving features powered by user
                                    feedback.
                                </li>
                        ...
                        <div>
                            ...
                            <p className="mt-2">
                                Join a growing community of fleet operators who trust Fleet Fusion
                                to manage their operations, improve compliance, and boost
                                profitability.
                            </p>
                        </div>
                    </section>
