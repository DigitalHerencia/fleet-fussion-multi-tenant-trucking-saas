    ...
    return (
        <div className="flex flex-col min-h-screen relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-0">
                <Image
                    src="/ChatGPT Image Apr 28, 2025, 03_14_27 PM.png"
                    ...
                    <div className="w-full max-w-3xl bg-card/90 backdrop-blur-sm rounded-lg shadow-md p-6 md:p-8 mx-auto mb-60 md:mb-80 lg:mb-96">
                        ...
                        <ol className="list-decimal pl-6 space-y-4 text-base text-foreground">
                            ...
                            <li>
                                ...
                                delete, or restrict the use of your personal information. Contact{" "}
                                <a
                            ...
                            <li>
                                ...
                                functionality, and marketing. You may adjust your browser settings
                                to decline cookies.
                            </li>
                            <li>
