                ...
                <div className="w-full max-w-3xl bg-card rounded-lg shadow-md p-8 mx-auto mb-8">
                    ...
                    <ol className="list-decimal pl-6 space-y-4 text-base text-foreground">
                        ...
                        <li>
                            ...
                            <br />
                            Fleet Fusion offers a 30-day free trial on all plans. If you cancel
                            during the trial period, you will not be charged.
                        </li>
                        <li>
                            <strong>Cancellations</strong>
                            <br />
                            You may cancel your subscription at any time via your account settings.
                            Cancellations are effective at the end of the current billing cycle. No
                            partial refunds are issued for unused portions of a billing cycle.
                        </li>
                        <li>
                            <strong>Refunds for Downtime</strong>
                            <br />
                            If Fleet Fusion fails to meet its SLA obligations, Customers may be
                            eligible for service credits as described in the SLA, not monetary
                            refunds.
                        </li>
                        <li>
                            <strong>Exceptional Circumstances</strong>
                            <br />
                            Fleet Fusion may, at its sole discretion, consider refund requests in
                            ...
                            All refund requests must be submitted within 30 days of the billing
                            event via{" "}
                            <a
                        ...
                        <li>
                            ...
                            <br />
                            If you initiate a chargeback or dispute on a legitimate charge, your
                            account may be immediately suspended pending resolution.
                        </li>
                        <li>
                            <strong>Modifications</strong>
                            <br />
                            Fleet Fusion reserves the right to update or modify this Refund Policy
                            at any time. Updates will be posted on the website.
                        </li>
                    </ol>
                </div>
            </main>
