                ...
                <div className="w-full max-w-3xl bg-card rounded-lg shadow-md p-8 mx-auto">
                    ...
                    <ol className="list-decimal pl-6 space-y-4 text-base text-foreground">
                        <li>
                            ...
                            <br />
                            This Service Level Agreement (“SLA”) outlines the service performance
                            standards that Fleet Fusion, LLC ("Fleet Fusion") guarantees to its
                            customers (“Customer”) subscribing to our Transportation Management
                            System (“TMS”) services.
                            <br />
                        ...
                        <li>
                            ...
                            <br />
                            Fleet Fusion commits to maintaining 99.9% uptime per calendar month for
                            the Fleet Fusion platform, excluding scheduled maintenance and force
                            majeure events.
                            <br />
                            <span className="block mt-2">
                                <strong>Uptime Definition:</strong> Availability of all critical
                                services necessary to operate fleet management features, excluding
                        ...
                        <li>
                            ...
                            <br />
                            Fleet Fusion will attempt to perform maintenance during off-peak hours
                            (typically between 12:00 AM – 4:00 AM MST).
                            <br />
                            ...
                            <table className="w-full text-sm border mb-2">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="border px-2 py-1">
                                            Platform unusable; core business impact (e.g., no
                                            access, dispatch failure)
                                        </td>
                        ...
                        <li>
                            ...
                            <br />
                            If Fleet Fusion fails to meet the 99.9% uptime guarantee in any calendar
                            month, Customers are eligible for a service credit:
                            <ul className="list-disc pl-6">
                                ...
                                <li>
                                    ...
                                    <ul className="list-disc pl-6">
                                        <li>
                                            Submit a written request to support@fleetfusion.app
                                            within 30 days of the downtime event.
                                        </li>
                                        <li>
                                            Include timestamps, impact descriptions, and any
                        ...
                        <li>
                            ...
                            <ul className="list-disc pl-6">
                                <li>
                                    Factors outside Fleet Fusion’s control (e.g., natural disasters,
                                    ISP failures).
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <br />
                            Fleet Fusion reserves the right to modify this SLA with 30 days' notice.
