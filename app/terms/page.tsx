    ...
    return (
        <div className="flex flex-col min-h-screen relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-0">
                <Image
                    src="/ChatGPT Image Apr 27, 2025, 03_33_25 PM.png"
                    ...
                    <div className="w-full max-w-3xl bg-card/90 backdrop-blur-sm rounded-lg shadow-md p-6 md:p-8 mx-auto mb-60 md:mb-80 lg:mb-96">
                        ...
                        <ol className="list-decimal pl-6 space-y-4 text-base text-foreground">
                            ...
                            <li>
                                ...
                                dispatch, compliance, billing, maintenance tracking, analytics, and
                                related features.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                of your credentials and all activities under your account.
                            </li>
                            <li>
                                ...
                                <span className="block mt-2">
                                    All prices are in USD. Taxes, SMS fees, and overages may apply.
                                    Payment is due monthly in advance. Failure to pay may result in
                            ...
                            <li>
                                ...
                                <br />
                                Fleet Fusion grants you a non-exclusive, non-transferable, revocable
                                license to use the Services for your internal business operations.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <br />
                                You retain ownership of all fleet data entered into the system. By
                                using the Services, you grant Fleet Fusion a limited license to use
                                anonymized, aggregated data to improve the Services.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <br />
                                Fleet Fusion may modify these Terms at any time by posting updated
                                Terms on the website. Continued use constitutes acceptance.
                            </li>
                            <li>
                                <strong>Warranties and Disclaimers</strong>
                                <br />
                                Fleet Fusion provides Services "as is." We disclaim all warranties,
                            ...
                            <li>
                                ...
                                <br />
                                Fleet Fusion shall not be liable for indirect, incidental, special,
