...
export function ExportOptions({ orgId, filters, data }: ExportOptionsProps) {
  ...
  const availableMetrics = [
    ...
    { id: 'driver_performance', label: 'Driver Performance', category: 'Performance' },
    { id: 'vehicle_utilization', label: 'Vehicle Utilization', category: 'Performance' },
    { id: 'on_time_delivery', label: 'On-Time Delivery %', category: 'Performance' },
    { id: 'geographic_analysis', label: 'Geographic Analysis', category: 'Analysis' },
  ];
