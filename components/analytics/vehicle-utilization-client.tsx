 ...
 */
export function VehicleUtilizationClient({ timeRange, data }: VehicleUtilizationClientProps) {
    return (
        <div className="space-y-6">
                                                ...
                                                <ChartTooltipContent>
                                                    ...
                                                    <div className="flex flex-col gap-1 mt-2">
                                                        <div className="flex justify-between items-center gap-8">
                                                            ...
                                                            <p className="font-medium">{data.miles.toLocaleString()}</p>
                                                        </div>
                                                    </div>
                                                </ChartTooltipContent>
                                            )
                    ...
                    >
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                                ...
                                />
                                <Bar dataKey="utilization" fill="hsl(var(--chart-2))" name="Utilization %" />
                            </BarChart>
                        </ResponsiveContainer>
                    </ChartContainer>
                </ContentSection>
            ...
            <ContentSection title="Fleet Performance Details" description={`Data for the last ${timeRange}`}>
                <Table>
                    <TableHeader>
                        <TableRow>
                    ...
                    <TableBody>
                        {data.map(vehicle => (
                            <TableRow key={vehicle.id}>
                                ...
                                <TableCell className="text-right">${vehicle.maintenance}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
