...
export async function VehicleUtilizationServer({ companyId, timeRange }: VehicleUtilizationServerProps) {
  ...
  const formattedVehicleData = vehicleData.map(vehicle => {
    ...
    const fuelEfficiency = vehicle.fuelConsumption && Number(vehicle.totalMiles) 
