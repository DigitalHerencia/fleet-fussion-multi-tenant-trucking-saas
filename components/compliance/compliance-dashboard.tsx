    ...
    async function fetchDashboardData() {
      try {
        ...
        const [metrics, deadlines] = await Promise.all([
          fetch(`/api/compliance/metrics?companyId=${companyId}`).then(
            (res) => {
              if (!res.ok)
          ...
          fetch(`/api/compliance/deadlines?companyId=${companyId}`).then(
            (res) => {
              if (!res.ok)
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {summaryMetrics.vehicleCompliance.needAttention} vehicles
                      need attention
                    </p>
                    <Progress
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {summaryMetrics.documentCompliance.needAttention} document
