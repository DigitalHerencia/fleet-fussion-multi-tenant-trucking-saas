            ...
            <div className="space-y-2">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar mode="single" required={true} selected={date} onSelect={(selectedDate: Date | undefined) => { if (selectedDate) setDate(selectedDate) }} />
                </PopoverContent>
              </Popover>
            </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">Available: 5:30</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-sm font-medium">On Duty Time</p>
                      <p className="text-2xl font-bold">8:00</p>
                      <p className="text-xs text-muted-foreground">Available: 6:00</p>
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="rounded-md border p-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">70-hour/8-day rule</p>
