      ...
      <CardHeader className="pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3 text-sm text-blue-100">
            ...
            <Badge variant="secondary" className="bg-blue-800 text-blue-100 border-blue-600">
              {lastUpdated || 'Never'}
            </Badge>
          </div>
        </div>
        ...
        <CardContent className="pt-0">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-xs text-blue-200">Total Vehicles</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-bold text-green-200">
                {summary.activeDrivers || 0}
              </div>
              <div className="text-xs text-blue-200">Active Drivers</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-bold text-white">
