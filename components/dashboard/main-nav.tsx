...
export function MainNav({ className }: MainNavProps) {
  return (
    <nav className={cn("flex items-center space-x-4 lg:space-x-6", className)}>
      <Link href="/dashboard" className="flex items-center gap-2 text-sm font-bold transition-colors hover:text-primary">
        <Image src="/map-pinned.png" alt="FleetFusion Logo" width={28} height={28} className="rounded" />
        FleetFusion
      </Link>
