        ...
        <div className="overflow-x-auto">
          <TabsList className="grid w-full min-w-[500px] grid-cols-5 rounded-md bg-zinc-800 p-1">
            ...
            >
              All{' '}
              <Badge
                className={`ml-2 ${activeTab === 'all' ? 'bg-primary text-white' : 'bg-zinc-900 text-white'}`}
              >
            ...
            >
              Pending{' '}
              <Badge
                className={`ml-2 ${activeTab === 'pending' ? 'bg-yellow-500 text-black' : 'bg-yellow-500/30 text-yellow-200'}`}
              >
            ...
            >
              Assigned{' '}
              <Badge
                className={`ml-2 ${activeTab === 'assigned' ? 'bg-blue-500 text-white' : 'bg-blue-500/30 text-blue-200'}`}
              >
            ...
            >
              In Transit{' '}
              <Badge
                className={`ml-2 ${activeTab === 'in_transit' ? 'bg-indigo-500 text-white' : 'bg-indigo-500/30 text-indigo-200'}`}
              >
            ...
            >
              Completed{' '}
              <Badge
                className={`ml-2 ${activeTab === 'completed' ? 'bg-green-500 text-white' : 'bg-green-500/30 text-green-200'}`}
              >
                  ...
                  <CardContent className="flex flex-1 flex-col justify-between">
                    <LoadCard
                      ...
                      onStatusUpdate={(loadId, status) =>
                        handleStatusUpdate(loadId, status as LoadStatus)
                      }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setFilters(prev => ({ ...prev, driverId: value }))
                  }
                >
                  <SelectTrigger>
