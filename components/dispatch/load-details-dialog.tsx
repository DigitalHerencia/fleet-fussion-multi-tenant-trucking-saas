...
export function LoadDetailsDialog({
  ...
  const [selectedDriverId, setSelectedDriverId] = useState(
    load.driver?.id || "not_assigned",
  );
  const [selectedVehicleId, setSelectedVehicleId] = useState(
    load.vehicle?.id || "not_assigned",
  );
  const [selectedTrailerId, setSelectedTrailerId] = useState(
    load.trailer?.id || "not_assigned",
  );
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      const driverId =
        selectedDriverId === "not_assigned" ? null : selectedDriverId;
      const vehicleId =
        selectedVehicleId === "not_assigned" ? null : selectedVehicleId;
      const trailerId =
        selectedTrailerId === "not_assigned" ? null : selectedTrailerId;
