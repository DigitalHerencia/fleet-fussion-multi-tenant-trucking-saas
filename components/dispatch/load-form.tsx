...
export function LoadForm({ drivers, vehicles, load, onClose }: LoadFormProps) {
  ...
  return (
    <Card className="bg-neutral-900 border border-gray-700 shadow-lg max-w-2xl mx-auto w-full">
      <CardHeader>
        <CardTitle className="text-xl font-bold text-white">{load ? "Edit Load" : "Create New Load"}</CardTitle>
      </CardHeader>
      <CardContent>
