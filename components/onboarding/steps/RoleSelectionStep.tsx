    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
        <div className="space-y-2">
          <Label htmlFor="role" className="text-sm font-medium text-gray-200">Select Your Role</Label>
          <Select
            value={formData.role}
          ...
          >
            ...
            <SelectContent className="bg-neutral-900 border-neutral-700">
              {roleOptions.map((role) => {
                ...
                return (
                  <SelectItem key={role.value} value={role.value} className="text-white hover:bg-neutral-800 focus:bg-neutral-800">
