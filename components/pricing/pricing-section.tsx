			...
			<div className="w-full container px-4 md:px-8 xl:px-32 relative z-10 py-12 md:py-24">
				...
				<div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
					{plans.map((plan) => (
						<div
							key={plan.name}
							className={`flex-1 rounded-2xl shadow-lg p-8 flex flex-col items-center transition-transform duration-200 bg-white dark:bg-zinc-900 ${
								plan.highlight
									? "ring-2 ring-blue-200 dark:ring-blue-900 scale-105 z-10"
									: ""
							}`}
						>
							<div className="mb-2 flex items-center gap-2">
								...
								{plan.highlight && (
									<span className="bg-blue-100 text-blue-500 dark:bg-blue-500 dark:text-white text-xs font-semibold px-2 py-1 rounded-full">
										MOST POPULAR
									</span>
								)}
							</div>
							<div className="text-4xl font-extrabold text-blue-500 dark:text-blue-500 mb-2">
								{plan.price}
							</div>
				...
				<p className="text-center text-xs text-white mt-8 mb-10">
