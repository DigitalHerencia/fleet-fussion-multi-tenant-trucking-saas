...
import { getCompanyDetails, updateCompany, getOrganizationMembers, inviteOrganizationMember, deleteCompany } from "@/lib/actions/company-actions"
...
export function CompanySettings() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(typeof result.error === "string" ? result.error : "Failed to update company information")
      }
    } catch (err) {
  ...
  const handleDeleteCompany = async () => {
    ...
    if (deleteConfirmText !== "DELETE") {
      toast({ title: "Error", description: "You must type DELETE to confirm deletion", variant: "destructive" }, {
        const: undefined,
        setError: function ( errorMessage: any ) {
          throw new Error( "Function not implemented." )
        }
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div
                className="h-24 w-24 rounded-md border flex items-center justify-center bg-muted company-avatar-bg"
              >
          ...
          <div className="flex justify-end gap-2">
            <Button variant="outline" type="button" onClick={fetchCompanyData} disabled={loading || saving}>
              Cancel
            </Button>
            ...
            {isAdmin && (
              <form onSubmit={handleInviteMember} className="mb-6">
                <div className="space-y-4">
                  ...
                  <Button type="submit" disabled={inviteLoading} className="flex items-center">
                    ...
                    <div key={member.id} className="flex items-center justify-between p-3 rounded-md border">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{member.publicUserData?.emailAddresses?.[0]?.emailAddress}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
              ...
              <div className="space-y-4 mt-8">
                ...
                <div className="space-y-2">
                  {pendingInvitations.map((invitation: any) => (
                    <div key={invitation.id} className="flex items-center justify-between p-3 rounded-md border border-dashed">
                      <div className="flex items-center gap-3">
                        <Avatar>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          ...
                          and remove all associated data including vehicles, drivers, loads, and other records.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="py-4">
