...
export function IntegrationSettings() {
    ...
    const [integrations, setIntegrations] = useState<Integration[]>(realIntegrations)

    const toggleIntegration = (id: number) => {
        setIntegrations(prev =>
            prev.map(integration => {
                if (integration.id === id && integration.available) {
                    const newStatus =
    ...
    const getStatusBadge = (status: string = "Not Connected") => {
        switch (status) {
            case "Connected":
                return (
        ...
        <div className="space-y-6">
                    ...
                    >
                        ...
                        <CardContent>
                            <div className="flex justify-between text-sm">
                                <span>Status:</span>
                                <span>{getStatusBadge(integration.status || "Not Connected")}</span>
                            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-100">
                ...
                <p className="text-blue-700 mb-3">
                    We're constantly expanding our integration capabilities. Have a specific
                    integration request?
                </p>
