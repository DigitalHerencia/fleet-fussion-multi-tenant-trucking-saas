...
export function SettingsDashboard({ 
  ...
  const accessibleTabs = (ROLE_TAB_ACCESS[userRole as keyof typeof ROLE_TAB_ACCESS] || ['user', 'notifications']) as readonly TabName[];
    ...
    <Card>
      ...
      <CardContent>
        <div className="text-center py-8 text-muted-foreground">
          ...
          <p className="text-sm">This will show all settings changes with timestamps and user details.</p>
        </div>
      </CardContent>
    </Card>
  );
