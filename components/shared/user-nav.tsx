...
export function UserNav() {
  ...
  const userName: string =
    typeof auth === "object" && auth && "name" in auth && typeof auth.name === "string"
      ? auth.name
      : "User"
    ...
    <div className="flex items-center gap-2 sm:gap-4">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            <Avatar className="h-10 w-10">
              <AvatarImage src="/black_logo.png" alt={userName} />
              <AvatarFallback>
        ...
        <DropdownMenuContent className="w-64 p-2" align="end" forceMount>
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem className="rounded-md px-3 py-2 hover:bg-accent/60 transition-colors cursor-pointer">
            Profile
          </DropdownMenuItem>
          <DropdownMenuItem className="rounded-md px-3 py-2 hover:bg-accent/60 transition-colors cursor-pointer">
            Settings
          ...
          <DropdownMenuItem
            ...
            className="rounded-md px-3 py-2 text-destructive hover:bg-destructive/10 cursor-pointer"
          >
            Log out
          </DropdownMenuItem>
        </DropdownMenuContent>
