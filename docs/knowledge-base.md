...
Welcome to the FleetFusion Knowledge Base. Here you can find answers to common questions and step-by-step guides for using the platform.
...
**Tip:** You can view the status of uploaded documents in the Compliance dashboard.
...
4. Send the invitation. The user will receive an email to join your company account.
