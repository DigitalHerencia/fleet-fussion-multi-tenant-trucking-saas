...
export default function ComplianceDocuments({ documents: initialDocuments }: ComplianceDocumentsProps) {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {doc.fileUrl && (
                  <Button variant="ghost" size="icon" onClick={() => setPreviewUrl(doc.fileUrl!)} title="Preview Document">
