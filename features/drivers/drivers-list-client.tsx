  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {drivers.map(driver => (
          <div key={driver.id} onClick={() => handleOpen(driver)} className="cursor-pointer border rounded p-4 hover:bg-muted">
            <div className="font-bold">{driver.firstName} {driver.lastName}</div>
