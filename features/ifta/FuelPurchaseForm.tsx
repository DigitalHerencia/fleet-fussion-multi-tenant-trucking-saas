    ...
    return (
        <form action={formAction} className="space-y-6">
            ...
            <div>
                ...
                <FormError message={errors.vehicleId?.message || state.errors.vehicleId?.[0]} />
            </div>
            <div>
                <label>Driver</label>
                ...
                <FormError message={errors.driverId?.message || state.errors.driverId?.[0]} />
            </div>
            <div>
                <label>Date</label>
            ...
            <div>
                ...
                <FormError message={errors.location?.message || state.errors.location?.[0]} />
            </div>
            <div>
            ...
            <div>
                ...
                <FormError message={errors.gallons?.message || state.errors.gallons?.[0]} />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" step="0.01" {...register("totalAmount")} className="input" />
                <FormError message={errors.totalAmount?.message || state.errors.totalAmount?.[0]} />
            </div>
            <div>
                <label>Notes</label>
