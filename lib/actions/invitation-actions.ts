...
function hasResourcePermission(currentUser: UserContext, action: string, resource: string): boolean {
  // TODO: Replace with real permission logic
  // Temporary: Only allow if user has a role of 'admin'
