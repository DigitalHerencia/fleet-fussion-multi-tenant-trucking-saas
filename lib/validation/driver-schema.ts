import { z } from "zod";
import { idSchema, isoDateString, optionalIsoDateString, phoneRegex } from "./common-schemas";
...
export const driverCoreSchema = z.object({
  ...
  phone: z.string().regex(phoneRegex, { message: "Invalid phone number format." }).optional().nullable(),
  licenseNumber: z.string().max(50, "License number is too long.").optional().nullable(),
  licenseState: z.string().max(50, "License state is too long.").optional().nullable(),
