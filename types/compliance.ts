...
export interface HosEntry {
  ...
  startTime: Date
  endTime: Date
  status: "driving" | "on_duty" | "off_duty" | "sleeper_berth" | "personal_conveyance" | "yard_moves"
  location: string
  odometer?: number
  engineHours?: number
  notes?: string
...
export interface HosViolation {
  id: string
  type: "11_hour" | "14_hour" | "70_hour" | "8_hour_break" | "30_minute_break" | "34_hour_restart" | "60_70_hour" | "other"
  description: string
...
export interface DvirDefect {
  id: string
  category: "brakes" | "coupling" | "engine" | "exhaust" | "fuel_system" | "lights" | "steering" | "tires" | "suspension" | "electrical" | "body" | "other"
  subcategory?: string
  description: string
...
export interface MaintenanceRecord {
  ...
  category: "engine" | "transmission" | "brakes" | "tires" | "electrical" | "hvac" | "body" | "other"
  description: string
  scheduledDate?: Date
  completedDate?: Date
  dueDate?: Date
...
export interface ComplianceAlert {
  id: string
  tenantId: string
  type: "expiring_document" | "hos_violation" | "maintenance_due" | "inspection_due" | "safety_event" | "audit_finding"
...
export interface AuditFinding {
  id: string
  category: "driver_qualification" | "hos" | "vehicle_maintenance" | "drug_testing" | "records" | "insurance" | "other"
