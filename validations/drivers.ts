...
export const driverFormSchema = z.object({
  ...
  // Medical Information
  medicalCardNumber: z.string().max(30, "Medical card number must be less than 30 characters").optional(),
...
export const driverDocumentSchema = z.object({
  ...
  issuingAuthority: z.string().max(100, "Issuing authority must be less than 100 characters").optional(),
