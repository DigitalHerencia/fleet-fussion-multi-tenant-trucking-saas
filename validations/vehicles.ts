...
export const VehicleFormSchema = z.object({
  ...
  nextMaintenanceMileage: z.number()
...
export const VehicleUpdateStatusSchema = z.object({
  status: z.enum(["available", "assigned", "in_maintenance", "out_of_service", "retired"], {
...
export const VehicleFiltersSchema = z.object({
  ...
  status: z.enum(["available", "assigned", "in_maintenance", "out_of_service", "retired"]).optional(),
